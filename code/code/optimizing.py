...
def get_optimizer(model, train_dataloader):
    ...
    optimizer_grouped_parameters = [
        ...
        {'params': [p for n, p in cur_model.model.named_parameters() if any(nd in n for nd in no_decay)],
         'weight_decay': 0.0},
        # {'params': [p for n, p in cur_model.cls.named_parameters() if not any(nd in n for nd in no_decay)], 'weight_decay': args.weight_decay},
        # {'params': [p for n, p in cur_model.cls.named_parameters() if any(nd in n for nd in no_decay)], 'weight_decay': 0.0}
    ]
    optimizer = AdamW(
        optimizer_grouped_parameters,
    ...
    embedding_parameters = [
        {'params': [p for p in cur_model.prompt_encoder.parameters()]}
    ]
