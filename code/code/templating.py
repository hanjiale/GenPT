...
# for TACRED
# valid_conditions = {'org:founded_by': ['organization:person'],
...
# for TACREV
# valid_conditions = {'org:founded_by': ['organization:person', 'person:person'],
...
#                     'per:title': ['person:organization', 'person:title', 'person:person', 'organization:person'],
#                     'per:siblings': ['person:person'],
#                     'per:religion': ['person:organization', 'organization:religion', 'person:religion'],
#                     'per:age': ['person:duration', 'person:number'],
...
#                     'org:top_members/employees': ['person:organization', 'organization:organization', 'organization:person', 'person:title'],
#                     'per:countries_of_residence': ['person:city', 'person:location', 'person:nationality', 'person:country'],
#                     'org:city_of_headquarters': ['person:city', 'organization:location', 'organization:state_or_province', 'organization:person', 'organization:city', 'organization:misc'],
#                     'org:members': ['organization:country', 'organization:organization'],
#                     'org:country_of_headquarters': ['organization:country', 'organization:location', 'person:country', 'organization:organization', 'organization:misc', 'person:nationality'],
#                     'per:spouse': ['organization:person', 'person:title', 'person:person'],
#                     'org:stateorprovince_of_headquarters': ['organization:location', 'person:country', 'organization:state_or_province', 'organization:misc', 'person:state_or_province'],
#                     'org:number_of_employees/members': ['organization:number'],
...
#                     'per:origin': ['organization:country', 'person:location', 'person:nationality', 'person:country'],
#                     'org:political/religious_affiliation': ['organization:religion', 'person:religion', 'organization:ideology'],
#                     'per:other_family': ['person:person'],
#                     'per:stateorprovince_of_birth': ['person:city', 'person:state_or_province'],
#                     'org:dissolved': ['organization:date'],
#                     'per:date_of_death': ['person:date', 'organization:date'],
#                     'org:shareholders': ['organization:organization', 'organization:person'],
#                     'per:alternate_names': ['person:organization', 'organization:person', 'person:misc', 'person:person'],
#                     'per:parents': ['person:person'],
...
#                     'org:founded': ['person:date', 'organization:date'],
