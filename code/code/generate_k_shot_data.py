...
def main():
    ...
    parser.add_argument("--seed", type=int, nargs="+",
                        default=[1, 2, 3, 4, 5],  # [100, 13, 21, 42, 87]
                        help="Random seeds")

    parser.add_argument("--data_dir", type=str, default="../../RE_data/re-tacred", help="Path to original data")
    parser.add_argument("--output_dir", type=str, default="../../RE_data/re-tacred", help="Output path")
